...
class KinetikCli < Formula
  ...
  if Hardware::CPU.arm?
    ...
    url "https://github.com/section6nz/kinetik-base/releases/download/v#{version}/kinetik-main-aarch64-apple-darwin", :using => GitHubPrivateRepositoryDownloadStrategy
